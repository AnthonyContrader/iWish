...
import com.it.contrader.domain.Product;
import com.it.contrader.repository.ProductRepository;
import com.it.contrader.service.ProductService;
import com.it.contrader.service.dto.ProductDTO;
import com.it.contrader.service.mapper.ProductMapper;
...
public class ProductResourceIntTest {
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getPriority()).isEqualTo(DEFAULT_PRIORITY);
        assertThat(testProduct.getProprietario_id()).isEqualTo(DEFAULT_PROPRIETARIO_ID);
    ...
    public void checkProprietario_idIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setProprietario_id(null);
    ...
    public void updateProduct() throws Exception {
        ...
        assertThat(testProduct.getPriority()).isEqualTo(UPDATED_PRIORITY);
        assertThat(testProduct.getProprietario_id()).isEqualTo(UPDATED_PROPRIETARIO_ID);
