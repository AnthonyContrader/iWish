...
import com.it.contrader.domain.Category;
import com.it.contrader.repository.CategoryRepository;
import com.it.contrader.service.CategoryService;
import com.it.contrader.service.dto.CategoryDTO;
import com.it.contrader.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    private static final Long DEFAULT_PROPRIETARIO_ID = 1L;
    private static final Long UPDATED_PROPRIETARIO_ID = 2L;
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getRating()).isEqualTo(DEFAULT_RATING);
        assertThat(testCategory.getProprietario_id()).isEqualTo(DEFAULT_PROPRIETARIO_ID);
    }
    ...
    public void checkProprietario_idIsRequired() throws Exception {
        int databaseSizeBeforeTest = categoryRepository.findAll().size();
        // set the field null
        category.setProprietario_id(null);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].proprietario_id").value(hasItem(DEFAULT_PROPRIETARIO_ID.intValue())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.proprietario_id").value(DEFAULT_PROPRIETARIO_ID.intValue()));
    }
    @Test
    @Transactional
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getRating()).isEqualTo(UPDATED_RATING);
        assertThat(testCategory.getProprietario_id()).isEqualTo(UPDATED_PROPRIETARIO_ID);
    }
