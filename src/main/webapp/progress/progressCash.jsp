...
<body>
   ...
   <form id="floatright" action="/progress/insertCash" method="post">
				...
				<div class="col-75">
					<input type="number" id="prodotto_id" name="prodotto_id"
						placeholder="inserisci id del Prodotto"required>
				</div>
			</div>		
				<!--<div class="row">
				<div class="col-25">
				...
				<div class="col-75">
					<input type="number" step=0.01 id="time" name="time"
						placeholder="inserisci quanti giorni vuoi risparmiare"required >
				</div>-->
		
	<div class="row">
				<div class="col-25">
					<label for="cash">Quanti soldi vuoi risparmiare al giorno?</label>
				</div>
				<div class="col-75">
					<input type="number"step=0.01 id="cash" name="cash"
						placeholder="inserisci i soldi ">
				</div>
